...
function renderTable() {
  ...
  Object.entries(groups).forEach(([subsector, tickers]) => {
    ...
    sorted.forEach(ticker => {
      ...
      // EV / EV-Sales / EV-FCF are not meaningful for bank subsectors
      // (deposit-funded balance sheet). Render "n/a" with a tooltip instead of
      // a misleading number. See isEvNonMeaningfulSubsector in utils.js.
